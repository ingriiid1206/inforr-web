...
const MENU = [
  // LANCHES
  {
    id: 1, nome: "Jeffim", sub: "Pudim",
    desc: "O pudim da galera! Cremoso, com calda dourada e sabor que passou direto na prova.",
  ...
  {
    id: 3, nome: "Crepião", sub: "Chocolate",
    desc: "Crepe recheado com chocolate derretido. Quente, doce e irresistível.",
  ...
  {
    id: 5, nome: "Disco Voador", sub: "Minipizza",
  ...
  {
    id: 7, nome: "Crepe Segundo", sub: "Presunto e queijo",
  ...
  {
    id: 9, nome: "Sarahlgados", sub: "",
    desc: "Combo de salgados da Sarah. Coxinha, bolinha de queijo e mais surpresas.",
  ...
  // DOCES
  {
    id: 2, nome: "Boloberto", sub: "Pé de moleque · Cenoura · Chocolate",
    desc: "Bolo caprichado em três sabores: pé de moleque, cenoura e chocolate. Escolha o seu.",
  ...
  {
    id: 4, nome: "Alfalysson", sub: "",
    desc: "Alfajor com aquele toque especial da turma de TI.",
  ...
  {
    id: 10, nome: "Sabritaliana", sub: "Palha Italiana",
  ...
  {
    id: 11, nome: "Paçochica", sub: "pequena, mas poderosa",
    desc: "Paçoca pequenininha com muito sabor de amendoim torrado.",
  ...
  {
    id: 13, nome: "Moleque Ney", sub: "",
    desc: "Pé-de-moleque crocante feito na hora. Clássico do arraiá.",
