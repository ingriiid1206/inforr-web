    ...
    games: [
      {
        ...
        image: "/static/jogos/brawlhalla.png",
      },
      {
        title: "Cuphead",
        genre: "Run and Gun",
        ...
        image: "/static/jogos/cuphead.png",
      },
      {
        title: "Gang Beasts",
        ...
        image: "/static/jogos/gangbeasts.png",
      },
      {
        title: "It Takes Two",
        ...
        image: "/static/jogos/ittakestwo.png",
      },
      {
        title: "Overcooked! (3 jogos)",
        ...
        image: "/static/jogos/overcooked2.png",
      },
      {
        ...
        image: "/static/jogos/stickfigth.png",
      },
      {
        ...
        image: "/static/jogos/totallyacuratebattlesimulator.png",
      },
      {
        ...
        image: "/static/jogos/towerfallascension.png",
      },
      {
        title: "Tricky Towers",
        ...
        image: "/static/jogos/trickytowers.png",
      },
      {
        ...
        image: "/static/jogos/ultimatechickenhorse.png",
      },
      {
        title: "Move or Die",
        genre: "Party Game",
        platform: "PC/Notebook",
        players: "2-4",
        description: "Se parar de se mover, você morre! Party game caótico e viciante.",
        tags: "party game, multiplayer, corrida",
        image: "/static/jogos/moveordie.png",
      },
      {
        title: "Pico Park",
        genre: "Puzzle Co-op",
        platform: "PC/Notebook",
        players: "2-8",
        description: "Puzzle cooperativo onde comunicação e trabalho em equipe são essenciais.",
        tags: "puzzle, cooperativo, multiplayer",
        image: "/static/jogos/picopark.png",
      },
      {
        title: "2XKO",
        genre: "Luta",
        platform: "PC/Notebook",
        players: "1-2",
        description: "O novo jogo de luta da Riot Games com campeões de League of Legends.",
        tags: "luta, multiplayer, competitivo",
        image: "/static/jogos/2xko.png",
      },
      {
        title: "Amazing Frog",
        genre: "Sandbox / Party Game",
        platform: "PC/Notebook",
        players: "1-4",
        description: "Simulador absurdo de sapo com física ragdoll hilária.",
        tags: "sandbox, party game, comédia",
        image: "/static/jogos/amazingfrog.png",
      },
      {
        title: "Noita",
        genre: "Roguelike / Magia",
        platform: "PC/Notebook",
        players: "1",
        description: "Um roguelike onde cada pixel é simulado. Magia e destruição em pixel art.",
        tags: "roguelike, magia, pixel art",
        image: "/static/jogos/noita.png",
      },
      {
        title: "Ultrakill",
        genre: "FPS / Ação",
        platform: "PC/Notebook",
        players: "1",
        description: "FPS ultra-rápido e violento. Você é uma máquina que se alimenta de sangue.",
        tags: "fps, ação, velocidade",
        image: "/static/jogos/ultrakill.png",
      },
      {
        title: "Buckshot Roulette",
        genre: "Terror / Estratégia",
        platform: "PC/Notebook",
        players: "1",
        description: "Uma roleta russa perturbadora contra uma entidade sombria. Tenha coragem.",
        tags: "terror, estratégia, suspense",
        image: "/static/jogos/buckshotroulette.png",
      },
    ],
  },
  {
    ...
    games: [
      {
        ...
        platform: "PC/Notebook",
        players: "1-10",
        description: "A evolução do clássico jogo de tiro tático com gráficos e física aprimorados.",
        tags: "fps, tático, tiro, multiplayer competitivo",
        image: "/static/jogos/counterstrike2.png",
      },
      {
        title: "Call of Duty",
        genre: "FPS / Ação",
        ...
        image: "/static/jogos/callofduty.png",
      },
      {
        title: "Fortnite",
        genre: "Battle Royale",
        ...
        image: "/static/jogos/fortnite.png",
      },
      {
        title: "Minecraft",
        ...
        image: "/static/jogos/minecraft.png",
      },
      {
        title: "Far Cry 6",
        ...
        platform: "PC/Notebook",
        players: "1",
        description: "Guerrilha tropical em Yara contra uma ditadura brutal.",
        tags: "fps, mundo aberto, ação, campanha",
        image: "/static/jogos/farcry6.png",
      },
      {
        title: "F1 (Formula 1)",
        ...
        platform: "PC/Notebook",
        players: "1-2",
        description: "A experiência mais realista da Fórmula 1 nos games.",
        tags: "corrida, simulação, esporte",
        image: "/static/jogos/f1.png",
      },
      {
    ...
    games: [
      {
        ...
        image: "/static/jogos/bombapatch.png",
      },
      {
        title: "FIFA",
        genre: "Esportes / Futebol",
        platform: "Xbox ONE",
        players: "1-4",
        description: "FIFA 18, 19, 20 e FC25 disponíveis. O principal simulador de futebol do mundo.",
        tags: "futebol, esporte, simulação, multiplayer",
        image: "/static/jogos/fifa.png",
      },
      {
        title: "NBA 2K",
        ...
        platform: "PC/Notebook",
        players: "1-2",
        description: "O melhor simulador de basquete com os melhores jogadores da NBA.",
        tags: "basquete, esporte, simulação",
        image: "/static/jogos/nba2k.png",
      },
      {
        title: "Super Mario Kart / Mario Kart World",
        genre: "Corrida / Party Game",
        platform: "PC/Notebook",
        players: "1-4",
        description: "Corridas caóticas e divertidas com os personagens do universo Mario.",
        tags: "corrida, party game, nintendo, multiplayer",
        image: "/static/jogos/mariokart.png",
      },
      {
        ...
        image: "/static/jogos/needforspeed.png",
      },
    ],
  },
  {
    ...
    games: [
      {
        ...
        image: "/static/jogos/dragonballzsparkingmeteor.png",
      },
      {
        ...
        platform: "PC/Notebook",
        players: "1-2",
        description: "A evolução espiritual do Budokai Tenkaichi com gráficos incríveis.",
        tags: "luta, anime, dragon ball, 3d",
        image: "/static/jogos/dragonballzero.png",
      },
      {
        title: "Injustice 2",
        genre: "Luta",
        ...
        image: "/static/jogos/injustice2.png",
      },
      {
        title: "MK11",
        genre: "Luta",
        ...
        image: "/static/jogos/mortalkombat.png",
      },
      {
        ...
        platform: "PC/Notebook",
        players: "1-2",
        description: "A nova era do Street Fighter com mecânicas modernas e personagens icônicos.",
        tags: "luta, arcade, competitivo",
        image: "/static/jogos/streetfighter6.png",
      },
      {
        title: "Tekken 8",
        genre: "Luta 3D",
        platform: "PC/Notebook",
        players: "1-2",
        description: "O duelo definitivo do King of Iron Fist Tournament com gráficos de ponta.",
        tags: "luta, 3d, competitivo",
        image: "/static/jogos/tekken8.png",
      },
      {
        title: "Naruto Shippuden: Ultimate Ninja Storm (2 jogos)",
        genre: "Luta / Anime",
        platform: "PC/Notebook",
        players: "1-2",
        description: "Reviva a história clássica do ninja Naruto com jutsus espetaculares.",
        tags: "luta, anime, ninja",
        image: "/static/jogos/narutostorm.png",
      },
      {
        ...
        platform: "PC/Notebook",
        players: "1-2",
        description: "O maior roster de personagens da franquia Naruto Storm em um único jogo.",
        tags: "luta, anime, ninja",
        image: "/static/jogos/narutostorm.png",
      },
      {
        ...
        tags: "luta, arcade, 2d",
        image: "/static/jogos/thekingoffighters.png",
      },
    ],
  },
  {
    ...
    games: [
      {
        ...
        image: "/static/jogos/fivenigthsatfreddys.png",
      },
      {
        ...
        image: "/static/jogos/nigthmarecreatures.png",
      },
      {
        title: "God of War",
        genre: "Ação / Aventura",
        ...
        players: "1",
        description: "A jornada épica de Kratos e Atreus na mitologia nórdica.",
        tags: "ação, aventura, campanha",
        image: "/static/jogos/godofwar.png",
      },
      {
        ...
        image: "/static/jogos/reddeadredemptionII.png",
      },
      {
        ...
        image: "/static/jogos/thelastofus.png",
      },
      {
      ...
      },
      {
        ...
        image: "/static/jogos/deadcells.png",
      },
    ],
  },
];
...
const specificPricing = [
  ...
  { name: "Grand Theft Auto: San Andreas",         price: "R$ 4,00", detail: "15 min",    platform: "PS2" },
  // PS4
  { name: "The Last of Us",                        price: "R$ 5,00", detail: "15 min",    platform: "PS4" },
  { name: "Red Dead Redemption 2",                 price: "R$ 5,00", detail: "15 min",    platform: "PS4" },
  ...
  // PC
  { name: "Brawlhalla",                            price: "R$ 4,00", detail: "10 min",    platform: "PC" },
  ...
  { name: "Five Nights at Freddy",                 price: "R$ 4,00", detail: "10 min",    platform: "PC" },
  { name: "Gang Beasts",                           price: "R$ 4,00", detail: "10 min",    platform: "PC" },
  { name: "Grand Theft Auto: V",                   price: "R$ 5,00", detail: "15 min",    platform: "PC" },
  { name: "TowerFall Ascension",                   price: "R$ 4,00", detail: "10 min",    platform: "PC" },
  { name: "Overcooked",                            price: "R$ 4,00", detail: "10 min",    platform: "PC" },
  { name: "Stick Fight",                           price: "R$ 4,00", detail: "10 min",    platform: "PC" },
  ...
  { name: "Naruto Shippuden",                      price: "R$ 4,00", detail: "10 min",    platform: "PC" },
  ...
  { name: "Totally Accurate Battle Simulator",     price: "R$ 4,00", detail: "10 min",    platform: "PC" },
